    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(physics: const AlwaysScrollableScrollPhysics(), padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _item(context, Icons.headset_mic_outlined, 'Policy Certificate', 'General service inquiries', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
          _item(context, Icons.check_circle_outline, 'Policy Confirmation', 'Duration, cover period, limits', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
          _item(context, Icons.shield_outlined, 'Policy Verification', 'Genuity verification', const Color(0xFFE8EAF6), const Color(0xFF283593)),
          _item(context, Icons.edit_document, 'Policy Endorsement', 'Policy alterations & changes', const Color(0xFFFFF3E0), const Color(0xFFE8923E)),
          const SizedBox(height: 24),
          _section('Document Services'),
          _item(context, Icons.description_outlined, 'No Claim Document', 'customers outside the country', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
          _item(context, Icons.verified_outlined, 'No Claim Verification', 'Document verification', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
          _item(context, Icons.credit_card_outlined, 'Request for brown card', 'Agent & Customer', const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
          const SizedBox(height: 24),
          _section('Information Services'),
          _item(context, Icons.location_on_outlined, 'Office Address', 'Location information', const Color(0xFFFFF3E0), const Color(0xFFE8923E)),
          _item(context, Icons.people_outline, 'Staff/Agent Information', 'General information', const Color(0xFFFFF3E0), const Color(0xFFE8923E)),
          const SizedBox(height: 24),
          _section('Claims & Updates'),
          _item(context, Icons.notifications_outlined, 'Claim Notification', 'New claim alerts', const Color(0xFFFCE4EC), const Color(0xFFE91E63)),
          _item(context, Icons.update_outlined, 'Claim Updates', 'Status updates', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
          const SizedBox(height: 24),
          _section('Enquiries'),
          _item(context, Icons.autorenew_outlined, 'Renewal Enquiries', 'Policy renewal questions', const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
          _item(context, Icons.info_outline, 'Product Enquiries', 'Product information', const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
          const SizedBox(height: 24),
          _section('Payment Services'),
          _item(context, Icons.payment_outlined, 'Online Payment Issues', 'Without insurance certificate', const Color(0xFFE3F2FD), const Color(0xFF1565C0)),
