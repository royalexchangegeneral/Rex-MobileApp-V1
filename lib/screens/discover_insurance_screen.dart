              ...
              children: [
                Expanded(
                    child: _buildCategoryCard(
                        ...
                        'Policy Basics',
                        '8 articles',
                        AppTheme.primaryNavy, onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) =>
                              CategoryArticlesScreen.policyBasics()));
                })),
                ...
                Expanded(
                    child: _buildCategoryCard(
                        ...
                        'Claims Guide',
                        '6 articles',
                        AppTheme.accentOrange, onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) =>
                              CategoryArticlesScreen.claimsGuide()));
                })),
              ],
            ),
              ...
              children: [
                ...
                Expanded(
                    child: _buildCategoryCard(
                        ...
                        'Property Cover',
                        '4 articles',
                        const Color(0xFFE91E63), onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) =>
                              CategoryArticlesScreen.propertyCover()));
                })),
              ],
            ),
            SizedBox(height: 28),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Get Insured Today',
                          style: TextStyle(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Understanding Your Insurance Policy',
                    style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                        color: Theme.of(context).colorScheme.onSurface)),
