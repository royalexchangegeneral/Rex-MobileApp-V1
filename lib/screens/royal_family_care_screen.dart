...
class RoyalFamilyCareScreen extends StatelessWidget {
  const RoyalFamilyCareScreen({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
        ...
        title: const Text('Royal Family Care', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16)), centerTitle: true,
      ...
      body: SingleChildScrollView(physics: const AlwaysScrollableScrollPhysics(), padding: const EdgeInsets.all(16),
        child: Column(children: [
          _fc(context, 'Option A', '₦250,000.00', '₦250,000.00', '₦50,000.00', '₦2625', '₦250,000.00', '₦50,000.00', '₦1125', const Color(0xFFFFF8E1), const Color(0xFFB8860B)),
          const SizedBox(height: 12),
          _fc(context, 'Option B', '₦500,000.00', '₦500,000.00', '₦100,000.00', '₦5250', '₦500,000.00', '₦100,000.00', '₦2250', const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
          const SizedBox(height: 12),
          _fc(context, 'Option C', '₦1,000,000.00', '₦1,000,000.00', '₦200,000.00', '₦10500', '₦1,000,000.00', '₦200,000.00', '₦4500', const Color(0xFFE0F7FA), const Color(0xFF00838F)),
          const SizedBox(height: 12),
          _gq(context),
  ...
  Widget _fc(BuildContext ctx, String t, String d, String dis, String m, String parentPrem, String childDis, String childMed, String childPrem, Color bg, Color ic) {
    return Container(clipBehavior: Clip.hardEdge, decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(12)),
      child: Stack(children: [
        Padding(padding: const EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _a(d, '(Death)'), const SizedBox(height: 4), _a(dis, '(Permanent Disability)'), _a(m, '(Medical Expenses)'),
          const SizedBox(height: 12),
          Text('$parentPrem Per Parent', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black)),
          const SizedBox(height: 8),
          Row(children: List.generate(20, (_) => Expanded(child: Container(margin: const EdgeInsets.symmetric(horizontal: 2), height: 1, color: Colors.grey[400])))),
          const SizedBox(height: 8),
          Text('For sum insured/benefit up to', style: TextStyle(fontSize: 10, color: Colors.grey[700])), const SizedBox(height: 8),
          _a(childDis, '(Permanent Disability)'), _a(childMed, '(Medical Expenses)'),
          const SizedBox(height: 12),
          Text('$childPrem Per Child', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black)),
          const SizedBox(height: 12),
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ElevatedButton(onPressed: () => Navigator.push(ctx, MaterialPageRoute(builder: (_) => HomeProtectionIdScreen(planType: 'Royal Family - $t', totalSteps: 4))),
        ...
        Positioned(top: 8, right: 8, child: Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: ic.withValues(alpha: 0.15), shape: BoxShape.circle),
          child: SvgPicture.asset('assets/icons/Layer_1.svg', width: 18, height: 18)))]));
  }
  Widget _gq(BuildContext ctx) {
    return Container(clipBehavior: Clip.hardEdge, decoration: BoxDecoration(color: const Color(0xFFF5F0E8), borderRadius: BorderRadius.circular(12)),
      child: Stack(children: [
        Padding(padding: const EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ElevatedButton(onPressed: () => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const QuoteScreen(insuranceType: 'Royal Family Care'))),
              style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primaryNavy, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 8), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
  ...
  Widget _a(String v, String l) => RichText(text: TextSpan(style: const TextStyle(fontSize: 12, color: Colors.black), children: [TextSpan(text: '$v ', style: const TextStyle(fontWeight: FontWeight.bold)), TextSpan(text: l, style: const TextStyle(color: Colors.grey))]));
