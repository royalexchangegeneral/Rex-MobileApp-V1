  ...
  Widget _buildFlatLayout(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Drivers & Riders Protection',
              style: TextStyle(
                  color: Theme.of(context).colorScheme.onSurface,
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                Container(
                    ...
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Drivers & Riders Protection',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color:
                          ...
                          SizedBox(height: 8),
                          Text(
                              'This product is a compensation plan specially designed for licensed, personal drivers, corporate drivers, commercial drivers, dispatch riders, tricycle riders and motorcycle riders to provide payment for medical expenses in event of an accident.',
                              style: TextStyle(
                                  fontSize: 11,
                                  color:
                                      Theme.of(context).colorScheme.onSurface,
