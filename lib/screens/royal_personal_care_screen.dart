  ...
  Widget _buildFlatLayout(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Royal Personal Care',
              style: TextStyle(
                  color: Theme.of(context).colorScheme.onSurface,
                ...
                Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                              'Ensure you have adequate provision for yourself against unforeseen circumstances. This product provides compensation for medical expenses, permanent disability and death.',
                              style: TextStyle(
                                  fontSize: 11,
                                  color:
                                      Theme.of(context).colorScheme.onSurface,
