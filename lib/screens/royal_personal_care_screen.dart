...
class RoyalPersonalCareScreen extends StatelessWidget {
  ...
  const RoyalPersonalCareScreen({super.key, this.isFromNewPolicy = false});

  final List<String> _cardImages = const ['assets/images/e2.png','assets/images/e2.png','assets/images/e2.png','assets/images/e2.png','assets/images/e2.png'];

  List<Map<String, String>> get _cardData => const [
    {'title': 'Option A', 'price': '₦2,625 yearly', 'death': '₦250,000.00', 'disability': '₦250,000.00', 'medical': '₦50,000.00', 'premium': '₦2625'},
    {'title': 'Option B', 'price': '₦3,375 yearly', 'death': '₦300,000.00', 'disability': '₦300,000.00', 'medical': '₦75,000.00', 'premium': '₦3375'},
    {'title': 'Option C', 'price': '₦5,250 yearly', 'death': '₦500,000.00', 'disability': '₦500,000.00', 'medical': '₦100,000.00', 'premium': '₦5250'},
    {'title': 'Option D', 'price': '₦7,875 yearly', 'death': '₦750,000.00', 'disability': '₦750,000.00', 'medical': '₦150,000.00', 'premium': '₦7875'},
    {'title': 'Option E', 'price': '₦10,500 yearly', 'death': '₦1,000,000.00', 'disability': '₦1,000,000.00', 'medical': '₦200,000.00', 'premium': '₦10500'},
  ];

  static const List<Color> _bgColors = [Color(0xFFE0F7FA), Color(0xFFE8F5E9), Color(0xFFE0F7FA), Color(0xFFE8EAF6), Color(0xFFFCE4EC)];
  static const List<Color> _icColors = [Color(0xFF00838F), Color(0xFF2E7D32), Color(0xFF00838F), Color(0xFF283593), Color(0xFF880E4F)];
  ...
  // Old flat layout for logged-in New Policy flow
  Widget _buildFlatLayout(BuildContext context) {
    return Scaffold(
      appBar: AppBar(elevation: 0,
        ...
        title: Text('Royal Personal Care', style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.bold, fontSize: 16)), centerTitle: true),
            ...
            return Padding(padding: EdgeInsets.only(bottom: 12), child: Container(
              ...
              child: Padding(padding: EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  ElevatedButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => PersonalCarePurchaseScreen(optionTitle: d['title']!, price: d['price']!))),
  ...
  // SliverAppBar layout for Explore Services (non-logged-in)
      ...
      SliverAppBar(expandedHeight: 450, pinned: false,
        ...
        flexibleSpace: FlexibleSpaceBar(background: Column(children: [
          Expanded(child: Stack(fit: StackFit.expand, children: [
            Image.asset('assets/images/e2.png', fit: BoxFit.cover),
          ...
          Container(color: ThemeHelper.getCardColor(context), padding: EdgeInsets.all(24), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Royal Personal Care', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface)), SizedBox(height: 8),
            Text('Ensure you have adequate provision for yourself against unforeseen circumstances. This product provides compensation for medical expenses, permanent disability and death.', style: TextStyle(fontSize: 11, color: Theme.of(context).colorScheme.onSurface, height: 1.4)),
          ])),
        ]))),
      ...
      child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.black.withValues(alpha: 0.4), Colors.black.withValues(alpha: 0.85)])),
        padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Align(alignment: Alignment.centerRight, child: ElevatedButton(
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => PersonalCarePurchaseScreen(optionTitle: data['title']!, price: data['price']!))),
