...
class RoyalPersonalCareScreen extends StatelessWidget {
  const RoyalPersonalCareScreen({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
        ...
        title: const Text('Royal Personal Care', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16)), centerTitle: true,
      ...
      body: SingleChildScrollView(physics: const AlwaysScrollableScrollPhysics(), padding: const EdgeInsets.all(16),
        child: Column(children: [
          _buildCard(context, 'Option A', '₦250,000.00', '₦250,000.00', '₦50,000.00', '₦2625', const Color(0xFFE0F7FA), const Color(0xFF00838F)),
          const SizedBox(height: 12),
          _buildCard(context, 'Option B', '₦300,000.00', '₦300,000.00', '₦75,000.00', '₦3375', const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
          const SizedBox(height: 12),
          _buildCard(context, 'Option C', '₦500,000.00', '₦500,000.00', '₦100,000.00', '₦5250', const Color(0xFFE0F7FA), const Color(0xFF00838F)),
          const SizedBox(height: 12),
          _buildCard(context, 'Option D', '₦750,000.00', '₦750,000.00', '₦150,000.00', '₦7875', const Color(0xFFE8EAF6), const Color(0xFF283593)),
          const SizedBox(height: 12),
          _buildCard(context, 'Option E', '₦1,000,000.00', '₦1,000,000.00', '₦200,000.00', '₦10500', const Color(0xFFFCE4EC), const Color(0xFF880E4F)),
          const SizedBox(height: 12),
      ...
      child: Stack(children: [
        Padding(padding: const EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ElevatedButton(onPressed: () => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const QuoteScreen(insuranceType: 'Royal Personal Care'))),
        ...
        Positioned(top: 8, right: 8, child: Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: const Color(0xFFB8860B).withValues(alpha: 0.15), shape: BoxShape.circle),
          child: SvgPicture.asset('assets/icons/svg3474.svg', width: 18, height: 18)))]));
  }
    ...
    return Container(clipBehavior: Clip.hardEdge, decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(12)),
      child: Stack(children: [
        Padding(padding: const EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ElevatedButton(onPressed: () => Navigator.push(ctx, MaterialPageRoute(builder: (_) => HomeProtectionIdScreen(planType: 'Royal Personal - $t', totalSteps: 4))),
              style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primaryNavy, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 8), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
