...
class HomeProtectionIdScreen extends StatefulWidget {
  ...
  const HomeProtectionIdScreen(
      {super.key, required this.planType, this.totalSteps = 4});
  @override
          ...
          children: [
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text('Step 2 of ${widget.totalSteps}',
                          style: TextStyle(
                              fontSize: 13,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // ID Type dropdown
                  Text('Select mode of Identification',
                      style: TextStyle(
                          fontSize: 14,
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (_selectedIdType != null &&
                          _idNumberController.text.trim().length == 11)
                      ? () {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (_) => QuoteScreen(
                                      insuranceType:
                                          'Home Protection - ${widget.planType}')));
                        }
                      : null,
