  ...
  List<Map<String, dynamic>> get _filteredPolicies {
    ...
    if (query.isNotEmpty) {
      policies = policies.where((p) {
        final text =
            '${p['title']} ${p['policyNo']} ${p['vehicle']}'.toLowerCase();
            ...
            ...List.generate(policies.length, (index) {
              return Padding(
                padding: EdgeInsets.only(
                    bottom: index < policies.length - 1 ? 14 : 0),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      (policy['statusColor'] as Color).withValues(alpha: 0.1),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color:
                              isRenewal ? Colors.red : AppTheme.accentOrange),
                    ),
                  ],
                ),
              ),
              ...
              onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) => PolicyDetailsScreen(
                            ...
                            policyNumber:
                                policy['policyNo'].replaceAll('Policy #', ''),
                            policyData:
