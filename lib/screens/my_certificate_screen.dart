...
class _MyCertificateScreenState extends State<MyCertificateScreen> {
  ...
  List<Map<String, String>> get _filteredCertificates {
    ...
    return _certificates.where((c) {
      final text = '${c['id']} ${c['type']} ${c['name']} ${c['policyNo']} ${c['certNo']}'.toLowerCase();
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => _callSupport(),
                    child: const Text('Contact Support', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppTheme.primaryNavy)),
                  ),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Details rows
          _buildDetailRow('Name of Policy', cert['name']!),
          const SizedBox(height: 10),
          _buildDetailRow('Policy No.', cert['policyNo']!),
          const SizedBox(height: 10),
          _buildDetailRow('Certificate No.', cert['certNo']!),
          const SizedBox(height: 10),
          _buildDetailRow('Date of the commencement', cert['startDate']!),
          const SizedBox(height: 10),
          _buildDetailRow('Date of expiry', cert['expiryDate']!, valueColor: Colors.red),
          const SizedBox(height: 16),
            ...
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  ...
                  icon: const Icon(Icons.share_outlined, size: 18, color: AppTheme.primaryNavy),
