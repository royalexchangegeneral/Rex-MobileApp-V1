...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Future<void> _downloadReport() async {
    ...
    if (_selectedFormat == -1) {
      _snack('Please select a download format');
      return;
    }
    if (_selectedDateRange == 3 && (_fromDate == null || _toDate == null)) {
    ...
    try {
      ...
      if (r.statusCode == 200 || r.statusCode == 201) {
        ...
        if (d is Map) {
          ...
          source.forEach((key, value) {
            if (value is Map &&
              ...
              final cnt = value['count'] is int
                  ? value['count']
                  : int.tryParse(value['count'].toString()) ?? 0;
              final records =
                  value['data'] is List ? value['data'] as List : [];
        ...
        if (grouped.isEmpty || totalRecords == 0) {
          _snack('No data / report for that period');
  ...
  Future<void> _generateGroupedCsv(
      File file, Map<String, dynamic> grouped) async {
  ...
  Future<void> _generateGroupedPdf(File file, Map<String, dynamic> grouped,
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (ctx) {
        final widgets = <pw.Widget>[
          ...
          pw.Text('Period: $period | From: $startDate | To: $endDate',
        ...
        for (final entry in grouped.entries) {
          ...
          widgets.add(pw.Header(
              level: 1, text: 'Policy Class: $className (Count: $count)'));
            ...
            Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Row(children: [
                        _buildFormatCard(0, Icons.description_outlined, 'CSV',
                            const Color(0xFF2E7D6F), const Color(0xFFE8F5E9)),
                        ...
                        const SizedBox(width: 12),
                        _buildFormatCard(2, Icons.table_chart_outlined, 'Excel',
