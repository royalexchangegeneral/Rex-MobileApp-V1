...
class ParcelProtectionPlanScreen extends StatelessWidget {
  ...
  List<Map<String, String>> get _cardData => const [
    {'title': 'Option A', 'price': '₦1,000 yearly', 'sumInsured': '₦100,000.00', 'premium': '₦1000'},
    {'title': 'Option B', 'price': '₦1,500 yearly', 'sumInsured': '₦150,000.00', 'premium': '₦1500'},
    {'title': 'Option C', 'price': '₦2,000 yearly', 'sumInsured': '₦200,000.00', 'premium': '₦2000'},
    {'title': 'Option D', 'price': '₦2,500 yearly', 'sumInsured': '₦250,000.00', 'premium': '₦2500'},
    {'title': 'Option E', 'price': '₦3,000 yearly', 'sumInsured': '₦300,000.00', 'premium': '₦3000'},
  ];

  static const List<Color> _bgColors = [Color(0xFFE8F5E9), Color(0xFFE3F2FD), Color(0xFFE8F5E9), Color(0xFFFCE4EC), Color(0xFFE8F5E9)];
  static const List<Color> _icColors = [Color(0xFF2E7D32), Color(0xFF2E7D32), Color(0xFF2E7D32), Color(0xFF880E4F), Color(0xFF2E7D32)];
            ...
            return Padding(padding: EdgeInsets.only(bottom: 12), child: Container(
              ...
              child: Padding(padding: EdgeInsets.all(14), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  ElevatedButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ParcelProtectionPurchaseScreen(optionTitle: d['title']!, price: d['price']!))),
      ...
      SliverAppBar(expandedHeight: 450, pinned: false,
        ...
        flexibleSpace: FlexibleSpaceBar(background: Column(children: [
          Expanded(child: Stack(fit: StackFit.expand, children: [
            Image.asset('assets/images/e9.png', fit: BoxFit.cover),
          ...
          Container(color: ThemeHelper.getCardColor(context), padding: EdgeInsets.all(24), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Parcel Protection Plan', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface)), SizedBox(height: 8),
            Text('This plan provides cover for your goods while in transit by road, rail, or inland waterway. It also covers your goods while boarding or unloading and while temporarily garaged in the course of transit.', style: TextStyle(fontSize: 11, color: Theme.of(context).colorScheme.onSurface, height: 1.4)),
          ])),
        ]))),
      ...
      child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.black.withValues(alpha: 0.4), Colors.black.withValues(alpha: 0.85)])),
        padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Align(alignment: Alignment.centerRight, child: ElevatedButton(
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ParcelProtectionPurchaseScreen(optionTitle: data['title']!, price: data['price']!))),
