...
class _EnterBvnScreenState extends State<EnterBvnScreen> {
  ...
  void _continue() {
    if (_bvnController.text.isNotEmpty || _hasDocument) {
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: (_bvnController.text.isNotEmpty || _hasDocument) ? _continue : null,
            style: ElevatedButton.styleFrom(
              backgroundColor: (_bvnController.text.isNotEmpty || _hasDocument)
